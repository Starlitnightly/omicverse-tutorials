...
- [Closing the loop — Build, Test and Learn](Tutorials-synbio/t_synbio_07_dbtl_cycle.ipynb) — DoE and resolution-IV screening, plate layout, Echo pick list, Opentrons protocol, thermocycler program, real plate-reader growth fitting, measured-vs-FBA coupling, Lenth effects with curvature, Gaussian-process batch proposal, tAI, graded RBS library, integration sites, plasmid burden
